      ...
      page: (
        <DivAddProductBox>
          <DivInfoVendorBoxSC>
            <SpanTextTitleSC>
              Profile name{' '}
              <DivButtonChangrInformSC onClick={onClickTab(1)}>Change the information</DivButtonChangrInformSC>
            </SpanTextTitleSC>
            <OlifnoSC>
              ...
              <LiInfoSC>
                Products:<GreenST>Готовые(1), На заказ(0), Все(1)</GreenST>
              </LiInfoSC>
                  ...
                  <DivInnerContentSC>
                    ...
                    <DivTwoSidesSC>
                      ...
                      <TextFieldStore
                        ...
                        type="text"
                        name="storeLocation"
                        placeholder="Krasnoyarsk region, Russia"
                      />
