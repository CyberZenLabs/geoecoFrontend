...
const Registration = (props) => {
  ...
  const handleSubmit = () => {
    ...
    // });
    // axios
    //   .get("http://radiant-river-29802.herokuapp.com/api/v1/tours")
    //   .then((res) => console.log(res));

    axios
      .post("http://radiant-river-29802.herokuapp.com/api/v1/users/signup", {
        firstName: "Kirdфыцйцвсфмz",
        lastName: "Kadcфйцывсфымdad",
        email: "kirdroasdфыыйфывмфсcv7z@gmail.com",
        password: "asdfasdf",
    ...
    //   fetch("http://radiant-river-29802.herokuapp.com/api/v1/tours")
    //     .then((req) => req.text())
    //     .then(console.log);
  };
  ...
  return (
    <Container maxWidth="sm">
      ...
      <DivBoxRowsSC>
        ...
        <DivBoxRowSC>
          <ButtonSC onClick={handleSubmit}>дальше</ButtonSC>
        </DivBoxRowSC>
        {error && <h1>{error}</h1>}
        <DivBoxRowSC>
          <DivBoxTextSC>
