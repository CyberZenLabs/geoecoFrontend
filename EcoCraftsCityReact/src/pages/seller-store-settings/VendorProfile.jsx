          ...
          <DivAddProductBox>
            <DivInfoVendorBoxSC>
              ...
              <OlifnoSC>
                ...
                <LiInfoSC>
                  Товары:<GreenST>Готовые(1), На заказ(0), Все(1)</GreenST>
                </LiInfoSC>
                <DivButtonChangrInformBottomSC onClick={onClickTab(1)}>
                  Изменить информацию
                </DivButtonChangrInformBottomSC>
              </OlifnoSC>
            </DivInfoVendorBoxSC>
            ...
            <DivInfoVendorBoxAdaptiveSC>
              ...
              <VenderCarouselReview></VenderCarouselReview>
            </DivInfoVendorBoxAdaptiveSC>
          </DivAddProductBox>
        ),
      },
                    ...
                    <DivInnerContentSC>
                      ...
                      <DivTwoSidesSC>
                        ...
                        <ButtonImgSC
                          ...
                          onClick={() => handleUploadFile('storePhotoRef')}
                        >
                          <OverlayProfileImgSC>
  ...
  const listContent = [
    {
      page: (
        <DivAddProductBox>
          <DivInfoVendorBoxSC>
            <SpanTextTitleSC>
              Имя профиля <DivButtonChangrInformSC onClick={onClickTab(1)}>Изменить информацию</DivButtonChangrInformSC>
            </SpanTextTitleSC>
            <OlifnoSC>
              <LiInfoSC>Адрес</LiInfoSC>
              <LiInfoSC>Время существования магазина</LiInfoSC>
